...
namespace hist_mmorpg
{
    public class LogInManager
    {
        ...
        /// </summary>
        public Dictionary<string, Tuple<byte[], byte[]>> users = new Dictionary<string, Tuple<byte[], byte[]>>();
        ...
        /// <returns></returns>
        public bool AcceptConnection(Client client, out ProtoLogIn response)
        {
